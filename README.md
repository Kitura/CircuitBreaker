...
## Swift version
The latest version of CircuitBreaker works with the `4.0` version of the Swift binaries. You can download this version of the Swift binaries by following this [link](https://swift.org/download/#releases).
